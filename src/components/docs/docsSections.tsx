...
import {
  ...
  PlaceholderDefaultsDocs,
  SecretEncryptionDocs,
  SecretVariablesDocs,
  TransformedPlaceholdersDocs,
  UnnamedReferencesDocs,
  VariableBooleanDocs,
  VariableCaseDocs,
  VariableConditionalDocs,
  VariableCountDocs,
  VariableDateDocs,
  VariableFillDocs,
  VariableHashDocs,
...
export const DOCS_SECTION_CONTENT: Record<DocsSectionId, ComponentType> = {
  ...
  [DocsSectionId.PLACEHOLDER_DEFAULTS]: PlaceholderDefaultsDocs,
  [DocsSectionId.VARIABLE_SLICING]: VariableSlicingDocs,
  [DocsSectionId.VARIABLE_LEN]: VariableLenDocs,
  [DocsSectionId.VARIABLE_COUNT]: VariableCountDocs,
  [DocsSectionId.VARIABLE_KEY]: VariableKeyDocs,
  [DocsSectionId.VARIABLE_HASH]: VariableHashDocs,
  [DocsSectionId.VARIABLE_CASE]: VariableCaseDocs,
  [DocsSectionId.VARIABLE_STRIP]: VariableStripDocs,
  [DocsSectionId.VARIABLE_FILL]: VariableFillDocs,
  [DocsSectionId.VARIABLE_REPLACE]: VariableReplaceDocs,
  [DocsSectionId.VARIABLE_INSERT]: VariableInsertDocs,
  [DocsSectionId.TRANSFORMED_PLACEHOLDERS]: TransformedPlaceholdersDocs,
  [DocsSectionId.UNNAMED_REFERENCES]: UnnamedReferencesDocs,
  [DocsSectionId.VARIABLE_DATE]: VariableDateDocs,
  [DocsSectionId.VARIABLE_BOOLEAN]: VariableBooleanDocs,
  [DocsSectionId.VARIABLE_LOGIC]: VariableLogicDocs,
  [DocsSectionId.VARIABLE_CONDITIONAL]: VariableConditionalDocs,
