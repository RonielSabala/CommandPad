...
export const DOCS_SECTION_ORDER: readonly DocsSectionEntry[] = [
  ...
  { id: DocsSectionId.VARIABLE_LEN, level: DocsSectionLevel.SUBSECTION },
  ...
  { id: DocsSectionId.VARIABLE_HASH, level: DocsSectionLevel.SUBSECTION },
  ...
  { id: DocsSectionId.AI_AGENT, level: DocsSectionLevel.SECTION },
