...
function resolveThemeColors() {
  return {
    ...
    flagText: resolveColor(ColorToken.FLAG_TEXT),
...
function buildTheme(theme: Theme): monaco.editor.IStandaloneThemeData {
  ...
  return {
    ...
    inherit: true,
    rules: [
      { token: MonacoTokenScope.NUMBER, foreground: c.constantText },
      { token: MonacoTokenScope.CONSTANT, foreground: c.constantText },
      { token: MonacoTokenScope.KEYWORD, foreground: c.accentText },
      { token: MonacoTokenScope.TYPE, foreground: c.accentText },
      { token: MonacoTokenScope.TAG, foreground: c.accentText },
      { token: MonacoTokenScope.VARIABLE, foreground: c.success },
      { token: MonacoTokenScope.REGEXP, foreground: c.success },
      { token: MonacoTokenScope.ATTRIBUTE_NAME, foreground: c.flagText },
      { token: MonacoTokenScope.DELIMITER, foreground: c.textSecondary },
      {
        token: MonacoTokenScope.COMMENT,
